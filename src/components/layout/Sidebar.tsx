...
const logisticItems: NavItem[] = [
  ...
  { label: 'Stock In', path: '/dashboard/logistics/stock-in', icon: <ArrowDownToLine className="w-5 h-5" /> },
  ...
  { label: 'Ninjavan Settings', path: '/dashboard/logistics/ninjavan-settings', icon: <Settings className="w-5 h-5" /> },
];

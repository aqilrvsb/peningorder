...
const logisticItems: NavItem[] = [
  ...
  { label: 'Shipped', path: '/dashboard/logistics/processed', icon: <CheckCircle className="w-5 h-5" /> },
...
const financeItems: NavItem[] = [
  ...
  { label: 'Expenses', path: '/dashboard/account/expenses', icon: <Receipt className="w-5 h-5" /> },
  ...
  const roleGroupsRaw: RoleGroup[] = isAdmin
    ...
    : isMarketer
      ? [
          ...
          // No Finance group for marketers — Salary is a standalone top-level tab
          // (rendered below), Report Profit is hidden.
        ]
      : isLogistic
